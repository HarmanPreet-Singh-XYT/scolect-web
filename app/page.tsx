    ...
    <div className="min-h-screen font-sans bg-zinc-50 dark:bg-zinc-950 text-zinc-900 dark:text-zinc-50 transition-colors duration-300">
      ...
      <Section id="features">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 auto-rows-fr">
          <FeatureCard 
            ...
            description="Scolect tracks every second you spend on your computer, automatically categorizing applications and providing detailed insights into your daily habits."
            points={[
          ...
          <FeatureCard 
            ...
            description="Scolect lets you mark applications as productive or non-productive, automatically calculating your Productive Score to measure your efficiency."
            points={[
          ...
          <FeatureCard 
            ...
            description="Set healthy boundaries with flexible time limits and smart notifications. Scolect alerts you when you're approaching limits, without nagging."
            points={[
          ...
          <FeatureCard 
            ...
            description="Take complete control over how Scolect tracks. Create custom categories, hide apps you don't want to track, and organize everything."
            points={[
      ...
      <Section id="how-it-works" className="bg-gradient-to-b from-zinc-50 to-white dark:from-zinc-900 dark:to-zinc-950 border-y border-zinc-200 dark:border-zinc-800 transition-colors">
        ...
        <div className="grid md:grid-cols-4 gap-8 relative">
          ...
          {[
            { icon: Download, title: "1. Download & Install", text: "Download Scolect for your platform. The installation is automatic—no technical knowledge required.", color: "violet" },
            { icon: Play, title: "2. Automatic Tracking", text: "Launch Scolect and it starts tracking instantly in the background. Intelligently monitoring usage with zero config.", color: "teal" },
      ...
      <Section>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {[
            { quote: "As a developer, I thought I had my screen time under control. Scolect proved me wrong. I was spending 4 hours daily on Slack and email. Now I batch communications and protect my deep work time.", role: "Software Engineer", name: "Alex Chen" },
          ...
          <div>
            ...
            <StaggerChildren className="grid sm:grid-cols-2 gap-4" staggerDelay={100} direction="right">
              ...
              <div className="bg-zinc-800 p-4 rounded-xl flex items-center gap-3 border border-zinc-700 hover:border-rose-500 transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-rose-500/20 group">
                ...
                <div>
                  <div className="text-white font-semibold">Native APIs</div>
