...
const FeatureHighlight = ({ icon: Icon, title, description, index = 0 }: { icon: any, title: string, description: string, index?: number }) => {
  ...
  return (
    <Reveal delay={index * 80}>
      <div 
        className="group relative flex gap-5 p-6 bg-white dark:bg-zinc-900/80 backdrop-blur-sm rounded-2xl border border-zinc-200 dark:border-zinc-800 hover:border-[#7C3AED]/40 transition-all duration-500 overflow-hidden hover:shadow-xl hover:shadow-[#7C3AED]/10 h-full"
        onMouseEnter={() => setIsHovered(true)}
        onMouseLeave={() => setIsHovered(false)}
      >
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <Reveal direction="left">
              <div className="group p-8 bg-gradient-to-br from-[#14B8A6]/10 to-[#14B8A6]/5 rounded-3xl border border-[#14B8A6]/20 hover:border-[#14B8A6]/40 transition-all duration-300 hover:shadow-xl hover:shadow-[#14B8A6]/10 h-full">
            ...
            <Reveal direction="right" delay={150}>
              <div className="group p-8 bg-gradient-to-br from-zinc-100 to-zinc-50 dark:from-zinc-900 dark:to-zinc-900/50 rounded-3xl border border-zinc-200 dark:border-zinc-800 hover:border-zinc-300 dark:hover:border-zinc-700 transition-all duration-300 hover:shadow-xl h-full">
