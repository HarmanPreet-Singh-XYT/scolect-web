        ...
        <main className="flex-1 min-w-0 py-12 px-6 lg:px-12">
          ...
          <Callout type="tip" title="Initial Steps">
            <ul className="list-disc pl-5 space-y-1">
              <li><strong>Grant Permissions:</strong> Scolect may request permissions to monitor foreground applications. This is necessary for tracking to work.</li>
          ...
          <Callout type="info" title="Privacy Note">
            <div className="flex items-start gap-2">
              ...
              <p>Scolect only tracks which application is active and for how long. It does <strong>NOT</strong> record:</p>
            </div>
          ...
          <Paragraph>
            Scolect uses system APIs to detect the foreground window at regular intervals (every few seconds). It logs the application name and timestamp, building a complete record of your computer usage.
          </Paragraph>
          ...
          <Paragraph>
            Scolect provides 10 pre-built categories like Productivity, Development, Social Media, and Entertainment.
          </Paragraph>
          ...
          <Paragraph>
            Go to <strong>Settings → Backup & Restore</strong> and Click Export. Find the backup in your Documents folder under <CodeSnippet>Scolect-Backups/</CodeSnippet>.
          </Paragraph>
          <Paragraph>
